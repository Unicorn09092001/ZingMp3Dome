...
import SidebarSubNavigation from "./components/SidbarSubNavigation/SidebarSubNavigation";
    ...
    >
      ...
      <div className="sidebar__create-playlist">
        ...
        <div className="sidebar__expand">
          <div
            className="sidebar__expand-btn btn--expand"
            onClick={handleExpandSidebar}
          >
            <i className="bi bi-chevron-right"></i>
          </div>
          <div
            className="sidebar__expand-btn btn--shrink"
