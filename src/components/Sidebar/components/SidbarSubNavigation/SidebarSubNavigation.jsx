...
function SidebarSubNavigation() {
  ...
  useEffect(() => {
    ...
    return () =>
      subnavElement.removeEventListener("scroll", handleShowBoxShadow);
  }, []);
  return (
    <div
    ...
    >
      <ul className="sidebar__nav-list">
        <li className="sidebar__nav-item subnab--item">
          <NavLink to="moi-phat-hanh" className="sidebar__item-link">
            <i className="bi bi-music-note-beamed"></i>
            <span>Nhạc Mới</span>
          </NavLink>
        </li>
        <li className="sidebar__nav-item subnab--item">
          <NavLink to="hub" className="sidebar__item-link">
            <i className="bi bi-slack"></i>
            <span>Thể Loại</span>
          </NavLink>
        </li>
        <li className="sidebar__nav-item subnab--item">
          <NavLink to="top100" className="sidebar__item-link">
            <i className="bi bi-star"></i>
            <span>Top 100</span>
          </NavLink>
        </li>
        <li className="sidebar__nav-item subnab--item">
          <NavLink to="the-loai-video" className="sidebar__item-link">
      ...
      <ul className="sidebar__subnav-menu">
        ...
        <li className="sidebar__menu-item">
          <NavLink to="/personal/songs" className="sidebar__menu-link">
            <svg
        ...
        <li className="sidebar__menu-item">
          <NavLink to="/personal/playlists" className="sidebar__menu-link">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
