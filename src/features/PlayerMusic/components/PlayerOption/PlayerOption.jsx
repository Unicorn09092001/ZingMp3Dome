...
import PlaylistTab from "components/Container/components/playlistTab/PlaylistTab";
  ...
  return (
    <div className="player__options hide-on-mobile">
      <div className="player__options-container">
        ...
        <div
          className="player__options-btn volume option-btn"
      ...
      {isOpenPlaylist ? (
        <PlaylistTab isOpen={isOpenPlaylist} />
      ) : (
        <PlaylistTab isClose={!isOpenPlaylist} />
      )}
    </div>
  );
}
